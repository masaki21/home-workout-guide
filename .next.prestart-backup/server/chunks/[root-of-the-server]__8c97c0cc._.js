...
function sitemap() {
    const baseUrl = (("TURBOPACK compile-time value", "http://localhost:3000") || "http://localhost:3000").replace(/\/$/, "");
    return [
        {
            url: `${baseUrl}/`,
...
;
const sitemapModule = {
    ...__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$sitemap$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c97c0cc._.js.map